...
var propertyHandlers = {
    '.': {
        verify: function (accum) {
            ...
            if ((accum.nextChar() === '.') && (accum.nextNextChar() === '.')) {
    ...
    '$': {
        verify: function (accum) {
            return (accum.index === 0) && (accum.nextChar() === '.');
        },
        update: function (accum) {
...
var nodeAccumulator = (function () {
    var prototype = {
        ...
        nextNextChar: function () {
            return this.expr.charAt(this.index + 2);
        },
...
exports.normalize = function (path) {
    var accum = nodeAccumulator(path);
    var nodes = accum.run();
    return nodes;
};
